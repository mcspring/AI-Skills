...
| SwiftLint concurrency-related warnings | Which specific lint rule triggered? | Use `references/migration.md` § Linting for rule intent and preferred fixes; avoid dummy awaits. | `references/migration.md` § Linting |
...
- Migration and tooling
  - `references/migration.md` — Swift 6 migration strategy, closure-to-async conversion, @preconcurrency, FRP migration, linting rules
- Glossary
