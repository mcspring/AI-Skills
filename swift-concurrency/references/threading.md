...
State can change between suspension points. Complete all state mutations before the first `await` inside an actor.

> See [actors.md § Actor Reentrancy](actors.md#actor-reentrancy) for full examples and solutions.
