...
Sharing a single `AsyncStream` between multiple consumers splits values unpredictably. See [async-sequences.md § Single consumer only](async-sequences.md#single-consumer-only).
